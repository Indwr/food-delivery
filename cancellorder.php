...
<body>
			...
			<div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cancelled Order List</h4>
                            </div>
                            <div class="card-body">
	...
	{
										   $rid = $sdata['id'];
											 $stmt = $mysqli->query("SELECT * FROM `tbl_order` where rest_id=".$rid." and o_status ='Cancelled'");
	}
	else 
	{
		$stmt = $mysqli->query("SELECT * FROM `tbl_order` where  o_status ='Cancelled'");
	}
$i = 0;
