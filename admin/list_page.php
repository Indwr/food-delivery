                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example">
                                        ...
                                        <tbody>
                                           <?php 
											 $stmt = $mysqli->query("SELECT * FROM `tbl_page`");
$i = 0;
while($row = $stmt->fetch_assoc())
{
	$i = $i + 1;
											?>
                                                ...
                                                <td><a href="add_page.php?id=<?php echo $row['id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
  $(document).ready(function() {
    toastr.error("Page Delete Successfully!!", "Page Section", {
                     timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
                    newestOnTop: !0,
