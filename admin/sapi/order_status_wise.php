...
else
{
	...
	if($status == 'Pending')
	{
  $sel = $mysqli->query("select * from tbl_order where rest_id=".$sid." and o_status !='Completed' and o_status !='Cancelled' order by id desc "); 
	}
	else if($status == 'Complete')
	{
  $sel = $mysqli->query("select * from tbl_order where rest_id=".$sid." and o_status ='Completed'  order by id desc "); 
	}
	else 
	{
		$sel = $mysqli->query("select * from tbl_order where rest_id=".$sid." and o_status ='Cancelled'  order by id desc "); 
	}
