...
echo date_format($date,"d-m-Y");
											   ...
											   <td> <?php echo $row['c_value']; ?></td>
												...
												<?php } ?>
                                                <td><a href="add_coupon.php?id=<?php echo $row['id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
  $(document).ready(function() {
    toastr.error("Coupon Delete Successfully!!", "Coupon Section", {
                     timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
                    newestOnTop: !0,
