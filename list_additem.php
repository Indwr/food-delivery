			...
			<div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add On Item List</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Add On Item Name</th>
                                                
                                                
                                                 <th>Add On Iem Price</th>
												
                                                <th>Add On Price Status</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php 
										   $rid = $sdata['id'];
											 $stmt = $mysqli->query("SELECT * FROM `addon_item` where rid=".$rid."");
$i = 0;
while($row = $stmt->fetch_assoc())
{
	$i = $i + 1;
											?>
												...
												<td><div class="badge light badge-success"> <?php $cdata = $mysqli->query("select * from addon_cat where id=".$row['addid']."")->fetch_assoc(); echo $cdata['title']; ?></div></td>
